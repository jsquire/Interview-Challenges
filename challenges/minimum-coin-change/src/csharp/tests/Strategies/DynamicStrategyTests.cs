...
namespace Squire.MinimumCoinChallenge.Tests
{
    ...
    ///
    [TestFixture]
    internal class DynamicStrategyTests
    {
        /// <summary>
        ...
        private static IEnumerable<object[]> SolvableCases
        {
            get
            {
                ...
                yield return new object[]
                {
                    ...
                    new[] { new CoinUse(1, 1), new CoinUse(9, 2), new CoinUse(22, 1) }
                };
            }
        }
        ...
        {
            var strategy = new DynamicStrategy();
            var result = strategy.Solve(1000, new[] { 1, 5, 10, 25, 50, 100 });
            ...
            Assert.That(total, Is.EqualTo(1000), "The total value of coins should equal the requested value.");
        }
